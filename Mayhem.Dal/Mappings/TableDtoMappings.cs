    ...
    public class TableDtoMappings : Profile
    {
        ...
        CreateMap<TournamentUserStatisticsDto, TournamentUserStatistics> ()
            ...
            CreateMap<TournamentDto, Tournaments>()
                ...
                .ForMember(x => x.TournamentWalletOwner, y => y.MapFrom(z => z.TournamentWalletOwner))
            ...
            CreateMap<QuestDetailsDto, QuestDetailsDtoResponse>()
                .ForMember(dest => dest.TournamentType, opt => opt.MapFrom(src => src.TournamentType));
